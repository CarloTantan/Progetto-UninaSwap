...
public class StoricoOfferte extends JFrame {
    ...
    public StoricoOfferte(MainController controller) {
        ...
        JLabel lblStoricoOfferte = new JLabel("Le Tue Offerte", javax.swing.SwingConstants.CENTER);
    ...
    /**
     * Carica le offerte dell'utente tramite il controller
     */
    private void caricaOfferte() {
        // ✅ Usa il controller invece del DAO
        offerteCaricate = controller.caricaOfferteUtente();
        
        if (offerteCaricate == null) {
            JOptionPane.showMessageDialog(this,
                "Errore nel caricamento delle offerte",
                "Errore",
                JOptionPane.ERROR_MESSAGE);
            offerteCaricate = new ArrayList<>();
        }
    ...
    /**
     * Mostra le offerte nel pannello
     */
    ...
    /**
     * Crea una card per visualizzare un'offerta
     */
    private JPanel creaCardOfferta(Offerta_entity offerta) {
        ...
        String titoloAnnuncio = controller.getTitoloAnnuncioDaOfferta(offerta.getIdOfferta());
        ...
        // ✅ Info venditore tramite controller
    ...
    /**
     * Crea un pannello con le informazioni del venditore
     */
    ...
    /**
     * Apre la schermata di modifica offerta
     */
    ...
    private void ritiraOfferta(Offerta_entity offerta) {
        ...
        if (scelta == JOptionPane.YES_OPTION) {
            ...
            if (risultato.startsWith("Offerta ritirata")) {
                JOptionPane.showMessageDialog(this,
                    risultato,
                    "Successo",
