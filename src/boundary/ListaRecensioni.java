...
public class ListaRecensioni extends JFrame {
    ...
    public ListaRecensioni(MainController controller) {
        ...
        this.indiciRecensioniCaricate = new ArrayList<>();
    ...
    private void caricaRecensioniInviate() {
        ...
        lblContatore.setText("Recensioni inviate: " + numRecensioni);
        ...
        if (numRecensioni == 0) {
            ...
            for (int i = 0; i < numRecensioni; i++) {
                ...
                panelRecensioni.add(creaCardRecensioneInviata(i));
    ...
    private void caricaRecensioniRicevute() {
        ...
        lblContatore.setText("Recensioni ricevute: " + numRecensioni + 
        ...
        if (numRecensioni == 0) {
            ...
            for (int i = 0; i < numRecensioni; i++) {
                indiciRecensioniCaricate.add(i);
                panelRecensioni.add(creaCardRecensioneRicevuta(i));
                panelRecensioni.add(Box.createVerticalStrut(15));
            }
        }
    ...
    private JPanel creaCardRecensioneInviata(int index) {
        ...
        int idOfferta = controller.getIdOffertaRecensioneInviata(index);
        String matricolaVenditore = controller.getMatricolaVenditoreRecensioneInviata(index);
    ...
    private JPanel creaCardRecensioneRicevuta(int index) {
        ...
        int idOfferta = controller.getIdOffertaRecensioneRicevuta(index);
        String matricolaAcquirente = controller.getMatricolaAcquirenteRecensioneRicevuta(index);
    ...
    private JPanel creaCard(int punteggio, String data, String commento, 
        ...
        // Pannello centrale con titolo annuncio e commento
    ...
    private JPanel creaPannelloStelle(int punteggio) {
        ...
        try {
            ...
            System.err.println("Errore nel caricamento icone stelle: " + e.getMessage());
        }
